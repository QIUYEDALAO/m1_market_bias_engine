#!/usr/bin/env python3
"""Build M1 market-bias feature rows from the normalized match table."""
...
INPUT_CSV = REPO_ROOT / "data" / "processed" / "normalized_matches" / "m1_matches_normalized.csv"
OUTPUT_DIR = REPO_ROOT / "data" / "processed" / "market_features"
OUTPUT_CSV = OUTPUT_DIR / "m1_market_features.csv"
REPORT_DIR = REPO_ROOT / "reports" / "data_audit"
REPORT_MD = REPORT_DIR / "m1_market_features_report.md"
REPORT_JSON = REPORT_DIR / "m1_market_features_report.json"

EXPECTED_ROWS = 10733
EXPECTED_COMPLETE_ROWS = 8982
EXPECTED_CURRENT_ROWS = 1751
    ...
    out.update(
        {
            ...
            "feature_source": "m1_normalized_matches",
            "backtest_run": "NO",
...
def self_check(stats: dict[str, Any]) -> dict[str, Any]:
    checks = {
        "input_rows_10733": stats["input_rows"] == EXPECTED_ROWS,
        "output_rows_10733": stats["output_rows"] == EXPECTED_ROWS,
        "complete_backtest_feature_rows_8982": stats["complete_backtest_feature_rows"]
        == EXPECTED_COMPLETE_ROWS,
        "current_not_for_backtest_feature_rows_1751": stats[
...
def render_markdown(report: dict[str, Any]) -> str:
    ...
    return "\n".join(
        [
            ...
            "only. It does not run a backtest and does not generate recommendations.",
            "",
            "## Feature Groups",
            "",
            markdown_table(
...
def main() -> int:
    ...
    print(f"m1_market_features: {checks['status']}")
